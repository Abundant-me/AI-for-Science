...
##### <a name="Protein Structure">Protein Structure</a> [[Back to TOC](#toc)]

 - Structural and functional properties of SARS-CoV-2 spike protein: potential antivirus drug development for COVID-19 `Nature` `2020` [[Paper](https://www.nature.com/articles/s41401-020-0485-4)]
 - Self-Supervised Graph Transformer on Large-Scale Molecular Data `NeurIPS` `2020` [[Paper](https://proceedings.neurips.cc/paper/2020/hash/94aef38441efa3380a3bed3faf1f9d5d-Abstract.html)]
 - Retrosynthesis Prediction with Conditional Graph Logic Network `NeurIPS` `2019` [[Paper](https://proceedings.neurips.cc/paper/2019/hash/0d2b2061826a5df3221116a5085a6052-Abstract.html)]
 - Retroxpert: Decompose retrosynthesis prediction like a chemist `NeurIPS` `2020` [[Paper](https://proceedings.neurips.cc/paper/2020/hash/819f46e52c25763a55cc642422644317-Abstract.html)]
...
##### <a name="3D Scene Reconstruction">3D Scene Reconstruction</a> [[Back to TOC](#toc)]
 ...
 - Neural scene representation and rendering `Science` `2018` [[Paper](https://www.science.org/doi/abs/10.1126/science.aar6170)]
